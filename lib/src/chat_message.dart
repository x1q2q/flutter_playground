// chat message with RenderBox
// references: https://gist.github.com/craiglabenz/c6fc52e3e61f66c51f7a858115bfce51
// from: https://www.youtube.com/watch?v=cq34RWXegM8
import 'dart:math';
...
class TimestampedChatMessage extends LeafRenderObjectWidget {
  ...
  RenderObject createRenderObject(BuildContext context) {
    ...
    return TimestampedChatMessageRenderObject(
      ...
      sentAtStyle: effectiveTextStyle.copyWith(color: Colors.deepPurple),
    );
  }
  ...
  void updateRenderObject(
    ...
    renderObject.sentAtStyle =
        effectiveTextStyle.copyWith(color: Colors.deepPurple);
